...
internal class ErrorHandlingTest {
    ...
    fun campaignList400() {
        ...
        val e = assertThrows<BadRequestException> { campaignService.list() }
    ...
    @Test
    fun campaignList400WithRawResponse() {
    ...
    fun campaignList401() {
        ...
        val e = assertThrows<UnauthorizedException> { campaignService.list() }
    ...
    @Test
    fun campaignList401WithRawResponse() {
        val campaignService = client.campaign().withRawResponse()
        stubFor(
            get(anyUrl())
                .willReturn(
    ...
    fun campaignList403() {
        ...
        val e = assertThrows<PermissionDeniedException> { campaignService.list() }
    ...
    @Test
    fun campaignList403WithRawResponse() {
        val campaignService = client.campaign().withRawResponse()
        stubFor(
            get(anyUrl())
                .willReturn(
    ...
    @Test
    fun campaignList404WithRawResponse() {
        val campaignService = client.campaign().withRawResponse()
        stubFor(
            get(anyUrl())
                .willReturn(
    ...
    fun campaignList422() {
        ...
        val e = assertThrows<UnprocessableEntityException> { campaignService.list() }
    ...
    @Test
    fun campaignList422WithRawResponse() {
        val campaignService = client.campaign().withRawResponse()
        stubFor(
            get(anyUrl())
                .willReturn(
    ...
    fun campaignList429() {
        ...
        val e = assertThrows<RateLimitException> { campaignService.list() }
    ...
    @Test
    fun campaignList429WithRawResponse() {
        val campaignService = client.campaign().withRawResponse()
        stubFor(
            get(anyUrl())
                .willReturn(
    ...
    fun campaignList500() {
        ...
        val e = assertThrows<InternalServerException> { campaignService.list() }
    ...
    @Test
    fun campaignList500WithRawResponse() {
        val campaignService = client.campaign().withRawResponse()
        stubFor(
            get(anyUrl())
                .willReturn(
    ...
    fun campaignList999() {
        ...
        val e = assertThrows<UnexpectedStatusCodeException> { campaignService.list() }
    ...
    @Test
    fun campaignList999WithRawResponse() {
        val campaignService = client.campaign().withRawResponse()
        stubFor(
            get(anyUrl())
                .willReturn(
    ...
    @Test
    fun campaignListInvalidJsonBody() {
        val campaignService = client.campaign()
        stubFor(
            get(anyUrl())
        ...
        val e = assertThrows<GrowsurfException> { campaignService.list() }
