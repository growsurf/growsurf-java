...
interface AccountServiceAsync {
     ...
     * verified are deleted automatically after 7 days. For security, the API key is rotated the
     * first time the account owner signs in to the GrowSurf dashboard. Some actions (such as
     * emailing participants) additionally require GrowSurf to verify the team first. Calling this
     * endpoint accepts those policies on the account holder's behalf.
     */
