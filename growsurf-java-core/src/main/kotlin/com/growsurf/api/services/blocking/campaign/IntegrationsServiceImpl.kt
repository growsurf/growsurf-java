...
class IntegrationsServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    IntegrationsService {

    private val withRawResponse: IntegrationsService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): IntegrationsService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): IntegrationsService =
        IntegrationsServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            IntegrationsServiceImpl.WithRawResponseImpl(
