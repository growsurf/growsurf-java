...
/**
 * A client for interacting with the Growsurf REST API synchronously. You can also switch to
...
interface GrowsurfClient {
    ...
    /** A view of [GrowsurfClient] that provides access to raw HTTP responses for each method. */
