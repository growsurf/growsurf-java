...
class ParticipantListCommissionsParams
private constructor(
    ...
    /** A builder for [ParticipantListCommissionsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(participantListCommissionsParams: ParticipantListCommissionsParams) =
            apply {
                id = participantListCommissionsParams.id
                participantIdOrEmail = participantListCommissionsParams.participantIdOrEmail
                limit = participantListCommissionsParams.limit
                nextId = participantListCommissionsParams.nextId
                status = participantListCommissionsParams.status
                additionalHeaders = participantListCommissionsParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    participantListCommissionsParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ParticipantListCommissionsParams].
         *
         ...
         */
        fun build(): ParticipantListCommissionsParams =
            ParticipantListCommissionsParams(
                checkRequired("id", id),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ParticipantListCommissionsParams &&
            id == other.id &&
    ...
    override fun toString() =
        "ParticipantListCommissionsParams{id=$id, participantIdOrEmail=$participantIdOrEmail, limit=$limit, nextId=$nextId, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
