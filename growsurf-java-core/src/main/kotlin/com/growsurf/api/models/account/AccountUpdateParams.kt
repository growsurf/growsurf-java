...
/** Updates your own account profile (`firstName`, `lastName`, `company`). */
...
private constructor(
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(company, firstName, lastName, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(company, firstName, lastName, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{company=$company, firstName=$firstName, lastName=$lastName, additionalProperties=$additionalProperties}"
    }
