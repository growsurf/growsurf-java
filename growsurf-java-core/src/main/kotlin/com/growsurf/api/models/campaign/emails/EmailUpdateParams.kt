 ...
 * fields you send are changed (a surgical merge); omitted fields are left untouched. The body is a
 * large, loosely-typed partial object modeled as free-form properties — set fields via
...
private constructor(
    ...
    /** The partial Emails configuration body properties to send with the request. */
    ...
    companion object {
        ...
        @JvmStatic fun none(): EmailUpdateParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(emailUpdateParams: EmailUpdateParams) = apply {
            ...
            additionalBodyProperties = emailUpdateParams.additionalBodyProperties.toMutableMap()
        }
    ...
    override fun toString() =
        "EmailUpdateParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
