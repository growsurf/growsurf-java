...
/** Retrieves analytics for a single participant. */
class ParticipantRetrieveAnalyticsParams
private constructor(
    ...
    /** A builder for [ParticipantRetrieveAnalyticsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(participantRetrieveAnalyticsParams: ParticipantRetrieveAnalyticsParams) =
            apply {
                id = participantRetrieveAnalyticsParams.id
                participantIdOrEmail = participantRetrieveAnalyticsParams.participantIdOrEmail
                days = participantRetrieveAnalyticsParams.days
                endDate = participantRetrieveAnalyticsParams.endDate
                include = participantRetrieveAnalyticsParams.include
                interval = participantRetrieveAnalyticsParams.interval
                startDate = participantRetrieveAnalyticsParams.startDate
                additionalHeaders = participantRetrieveAnalyticsParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    participantRetrieveAnalyticsParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ParticipantRetrieveAnalyticsParams].
         *
         ...
         */
        fun build(): ParticipantRetrieveAnalyticsParams =
            ParticipantRetrieveAnalyticsParams(
                checkRequired("id", id),
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                ...
                include?.let { put("include", it.toString()) }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ParticipantRetrieveAnalyticsParams &&
            id == other.id &&
    ...
    override fun toString() =
        "ParticipantRetrieveAnalyticsParams{id=$id, participantIdOrEmail=$participantIdOrEmail, days=$days, endDate=$endDate, include=$include, interval=$interval, startDate=$startDate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
