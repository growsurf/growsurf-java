...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): WebhookListParams =
            WebhookListParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "WebhookListParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
