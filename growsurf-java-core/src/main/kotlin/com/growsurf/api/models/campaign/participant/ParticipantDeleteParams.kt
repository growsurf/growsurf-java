...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ParticipantDeleteParams].
         *
    ...
    /** A builder for [ParticipantDeleteParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(participantDeleteParams: ParticipantDeleteParams) = apply {
            id = participantDeleteParams.id
            participantIdOrEmail = participantDeleteParams.participantIdOrEmail
            additionalHeaders = participantDeleteParams.additionalHeaders.toBuilder()
            additionalQueryParams = participantDeleteParams.additionalQueryParams.toBuilder()
            additionalBodyProperties =
                participantDeleteParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ParticipantDeleteParams].
         *
         ...
         */
        fun build(): ParticipantDeleteParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ParticipantDeleteParams &&
            id == other.id &&
    ...
    override fun toString() =
        "ParticipantDeleteParams{id=$id, participantIdOrEmail=$participantIdOrEmail, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
