...
private constructor(
    ...
    /** A builder for [ParticipantListReferralsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(participantListReferralsParams: ParticipantListReferralsParams) = apply {
            id = participantListReferralsParams.id
            participantIdOrEmail = participantListReferralsParams.participantIdOrEmail
            desc = participantListReferralsParams.desc
            email = participantListReferralsParams.email
            firstName = participantListReferralsParams.firstName
            lastName = participantListReferralsParams.lastName
            limit = participantListReferralsParams.limit
            nextId = participantListReferralsParams.nextId
            offset = participantListReferralsParams.offset
            referralStatus = participantListReferralsParams.referralStatus
            sortBy = participantListReferralsParams.sortBy
            additionalHeaders = participantListReferralsParams.additionalHeaders.toBuilder()
            additionalQueryParams = participantListReferralsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ParticipantListReferralsParams].
         *
         ...
         */
        fun build(): ParticipantListReferralsParams =
            ParticipantListReferralsParams(
                checkRequired("id", id),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ParticipantListReferralsParams &&
            id == other.id &&
    ...
    override fun toString() =
        "ParticipantListReferralsParams{id=$id, participantIdOrEmail=$participantIdOrEmail, desc=$desc, email=$email, firstName=$firstName, lastName=$lastName, limit=$limit, nextId=$nextId, offset=$offset, referralStatus=$referralStatus, sortBy=$sortBy, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
