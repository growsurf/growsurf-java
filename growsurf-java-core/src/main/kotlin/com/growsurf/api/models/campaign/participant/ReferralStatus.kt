...
class ReferralStatus @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        @JvmField val INVITE_SENT = of("INVITE_SENT")
    ...
    enum class Value {
        ...
        INVITE_SENT,
        /**
         * An enum member indicating that [ReferralStatus] was instantiated with an unknown value.
         */
        _UNKNOWN,
    }
