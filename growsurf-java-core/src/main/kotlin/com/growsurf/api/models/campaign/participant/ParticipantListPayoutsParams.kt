...
class ParticipantListPayoutsParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ParticipantListPayoutsParams].
         *
    ...
    /** A builder for [ParticipantListPayoutsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(participantListPayoutsParams: ParticipantListPayoutsParams) = apply {
            id = participantListPayoutsParams.id
            participantIdOrEmail = participantListPayoutsParams.participantIdOrEmail
            limit = participantListPayoutsParams.limit
            nextId = participantListPayoutsParams.nextId
            status = participantListPayoutsParams.status
            additionalHeaders = participantListPayoutsParams.additionalHeaders.toBuilder()
            additionalQueryParams = participantListPayoutsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ParticipantListPayoutsParams].
         *
         ...
         */
        fun build(): ParticipantListPayoutsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ParticipantListPayoutsParams &&
            id == other.id &&
    ...
    override fun toString() =
        "ParticipantListPayoutsParams{id=$id, participantIdOrEmail=$participantIdOrEmail, limit=$limit, nextId=$nextId, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
