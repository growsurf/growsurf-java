...
class ReferralSource @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    /** An enum containing [ReferralSource]'s known values. */
    enum class Known {
        DIRECT,
        PARTICIPANT,
    }
    ...
    /**
     * An enum containing [ReferralSource]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [ReferralSource] can contain an unknown value in a couple of cases:
     ...
     *   expected type.
     */
    fun validate(): ReferralSource = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ReferralSource && value == other.value
    }
