...
class ParticipantListActivityLogsParams
private constructor(
    ...
    companion object {
         ...
         * [ParticipantListActivityLogsParams].
         *
    ...
    /** A builder for [ParticipantListActivityLogsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(participantListActivityLogsParams: ParticipantListActivityLogsParams) =
            apply {
                id = participantListActivityLogsParams.id
        ...
        /**
         * Returns an immutable instance of [ParticipantListActivityLogsParams].
         *
         ...
         */
        fun build(): ParticipantListActivityLogsParams =
            ParticipantListActivityLogsParams(
                checkRequired("id", id),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ParticipantListActivityLogsParams &&
            id == other.id &&
    ...
    override fun toString() =
        "ParticipantListActivityLogsParams{id=$id, participantIdOrEmail=$participantIdOrEmail, limit=$limit, offset=$offset, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
