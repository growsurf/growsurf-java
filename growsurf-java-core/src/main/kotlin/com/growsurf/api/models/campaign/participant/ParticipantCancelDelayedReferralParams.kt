...
private constructor(
    ...
    /** A builder for [ParticipantCancelDelayedReferralParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            participantCancelDelayedReferralParams: ParticipantCancelDelayedReferralParams
        ) = apply {
            id = participantCancelDelayedReferralParams.id
            participantIdOrEmail = participantCancelDelayedReferralParams.participantIdOrEmail
            additionalHeaders = participantCancelDelayedReferralParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                participantCancelDelayedReferralParams.additionalQueryParams.toBuilder()
            additionalBodyProperties =
                participantCancelDelayedReferralParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ParticipantCancelDelayedReferralParams].
         *
         ...
         */
        fun build(): ParticipantCancelDelayedReferralParams =
            ParticipantCancelDelayedReferralParams(
                checkRequired("id", id),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ParticipantCancelDelayedReferralParams &&
            id == other.id &&
    ...
    override fun toString() =
        "ParticipantCancelDelayedReferralParams{id=$id, participantIdOrEmail=$participantIdOrEmail, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
