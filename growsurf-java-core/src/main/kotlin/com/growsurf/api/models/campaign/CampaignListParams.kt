...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): CampaignListParams =
            CampaignListParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "CampaignListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
