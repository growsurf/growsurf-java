...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): IntegrationListParams =
            IntegrationListParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "IntegrationListParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
