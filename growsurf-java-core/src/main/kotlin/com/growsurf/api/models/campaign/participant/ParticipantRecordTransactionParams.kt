 ...
 * `subscriptionId` do not count, since they identify the customer or subscription rather than the
 * specific transaction. Without an identifier, resending the same sale creates a duplicate
