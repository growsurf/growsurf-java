 ...
 * provider.
 */
class ParticipantRequestPayoutDestinationConfirmationParams
private constructor(
    ...
    companion object {
         ...
         * [ParticipantRequestPayoutDestinationConfirmationParams].
         *
    ...
    /** A builder for [ParticipantRequestPayoutDestinationConfirmationParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = participantRequestPayoutDestinationConfirmationParams.id
            participantIdOrEmail =
                participantRequestPayoutDestinationConfirmationParams.participantIdOrEmail
            body = participantRequestPayoutDestinationConfirmationParams.body.toBuilder()
            additionalHeaders =
                participantRequestPayoutDestinationConfirmationParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                participantRequestPayoutDestinationConfirmationParams.additionalQueryParams
                    .toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ParticipantRequestPayoutDestinationConfirmationParams].
         *
         ...
         */
        fun build(): ParticipantRequestPayoutDestinationConfirmationParams =
            ParticipantRequestPayoutDestinationConfirmationParams(
                checkRequired("id", id),
                participantIdOrEmail,
                body.build(),
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("provider", provider), additionalProperties.toMutableMap())
        }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (provider.asKnown().getOrNull()?.validity() ?: 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(provider, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{provider=$provider, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ParticipantRequestPayoutDestinationConfirmationParams &&
            id == other.id &&
    ...
    override fun toString() =
        "ParticipantRequestPayoutDestinationConfirmationParams{id=$id, participantIdOrEmail=$participantIdOrEmail, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
