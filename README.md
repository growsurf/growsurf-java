...
[![Maven Central](https://img.shields.io/maven-central/v/com.growsurf.api/growsurf-java)](https://central.sonatype.com/artifact/com.growsurf.api/growsurf-java/1.8.1)
[![javadoc](https://javadoc.io/badge2/com.growsurf.api/growsurf-java/1.8.1/javadoc.svg)](https://javadoc.io/doc/com.growsurf.api/growsurf-java/1.4.0)
...
The REST API documentation can be found in the [GrowSurf API reference](https://docs.growsurf.com/developer-tools/rest-api/api-reference). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.growsurf.api/growsurf-java/1.8.1).
...
```kotlin
implementation("com.growsurf.api:growsurf-java:1.8.1")
```
