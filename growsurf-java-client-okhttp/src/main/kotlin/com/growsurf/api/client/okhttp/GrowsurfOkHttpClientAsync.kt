...
import com.growsurf.api.client.GrowsurfClientAsyncImpl
import com.growsurf.api.core.ClientOptions
import com.growsurf.api.core.LogLevel
import com.growsurf.api.core.Sleeper
import com.growsurf.api.core.Timeout
...
/**
 * A class that allows building an instance of [GrowsurfClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class GrowsurfOkHttpClientAsync private constructor() {
    ...
    companion object {
         ...
         */
        @JvmStatic fun fromEnv(): GrowsurfClientAsync = builder().fromEnv().build()
    }

    /** A builder for [GrowsurfOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         */
        fun build(): GrowsurfClientAsync =
            GrowsurfClientAsyncImpl(
                clientOptions
                    .httpClient(
