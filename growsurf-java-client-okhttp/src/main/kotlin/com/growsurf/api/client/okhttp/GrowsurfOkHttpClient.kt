...
import com.growsurf.api.client.GrowsurfClientImpl
...
/**
 * A class that allows building an instance of [GrowsurfClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class GrowsurfOkHttpClient private constructor() {
    ...
    companion object {
         ...
         */
        @JvmStatic fun fromEnv(): GrowsurfClient = builder().fromEnv().build()
    }

    /** A builder for [GrowsurfOkHttpClient]. */
